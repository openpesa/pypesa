...
@patch('pypesa.vodacom.MPESA.customer2business')
def test_customer2business_successful_transaction(mock_customer2business):
...
@patch('pypesa.vodacom.MPESA.customer2business')
def test_customer2business_duplicate_transaction(mock_customer2business):
